...
object AppChooserButton {
  val Heading: ExternalVar.Aux[AppChooserButton, java.lang.String | Null] = ExternalVar[AppChooserButton, java.lang.String | Null]("heading", _.getHeading(), _.setHeading(_), true)
