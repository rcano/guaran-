...
object Widget {
  ...
  val CssClasses: ExternalVar.Aux[Widget, Array[java.lang.String | Null]] = ExternalVar[Widget, Array[java.lang.String | Null]]("css-classes", _.getCssClasses(), _.setCssClasses(_), true)
