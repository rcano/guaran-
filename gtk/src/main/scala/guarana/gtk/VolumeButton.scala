...
opaque type VolumeButton <: guarana.gtk.Widget  = org.gnome.gtk.VolumeButton & guarana.gtk.Widget
object VolumeButton extends VarsMap {
  ...
  def wrap(v: org.gnome.gtk.VolumeButton): VolumeButton = 
    val res = v.asInstanceOf[VolumeButton]
