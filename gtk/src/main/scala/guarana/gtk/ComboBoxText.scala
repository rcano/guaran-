...
opaque type ComboBoxText <: guarana.gtk.Widget  = org.gnome.gtk.ComboBoxText & guarana.gtk.Widget
object ComboBoxText extends VarsMap {
  ...
  def wrap(v: org.gnome.gtk.ComboBoxText): ComboBoxText = 
    val res = v.asInstanceOf[ComboBoxText]
  ...
  def uninitialized(hasEntry: Opt[Boolean], hasFrame: Opt[Boolean], cssName: Opt[java.lang.String], heightRequest: Opt[Int], widthRequest: Opt[Int], accessibleRole: Opt[org.gnome.gtk.AccessibleRole], editingCanceled: Opt[Boolean]): ComboBoxText = {
    val res = {
      val res = org.gnome.gtk.ComboBoxText.builder()
