...
object TreeExpander extends VarsMap {
  ...
  def uninitialized(cssName: Opt[java.lang.String], heightRequest: Opt[Int], widthRequest: Opt[Int], accessibleRole: Opt[org.gnome.gtk.AccessibleRole]): TreeExpander = {
    val res = {
      val res = org.gnome.gtk.TreeExpander.builder()
