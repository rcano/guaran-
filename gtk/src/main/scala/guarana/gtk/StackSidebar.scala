...
object StackSidebar extends VarsMap {
  ...
  def _wrap(v: org.gnome.gtk.StackSidebar): StackSidebar = {
    v.asInstanceOf
  }
  def init(v: StackSidebar): ToolkitAction[Toolkit, Unit] = {
    Widget.init(v)
