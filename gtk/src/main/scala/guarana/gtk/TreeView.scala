...
object TreeView extends VarsMap {
  ...
  def apply(activateOnSingleClick: Opt[Binding[Boolean]] = UnsetParam, canFocus: Opt[Binding[Boolean]] = UnsetParam, canTarget: Opt[Binding[Boolean]] = UnsetParam, childVisible: Opt[Binding[Boolean]] = UnsetParam, cursor: Opt[Binding[org.gnome.gdk.Cursor | Null]] = UnsetParam, direction: Opt[Binding[org.gnome.gtk.TextDirection]] = UnsetParam, enableSearch: Opt[Binding[Boolean]] = UnsetParam, enableTreeLines: Opt[Binding[Boolean]] = UnsetParam, expanderColumn: Opt[Binding[org.gnome.gtk.TreeViewColumn | Null]] = UnsetParam, fixedHeightMode: Opt[Binding[Boolean]] = UnsetParam, focusChild: Opt[Binding[org.gnome.gtk.Widget | Null]] = UnsetParam, focusOnClick: Opt[Binding[Boolean]] = UnsetParam, focusable: Opt[Binding[Boolean]] = UnsetParam, fontMap: Opt[Binding[org.gnome.pango.FontMap | Null]] = UnsetParam, fontOptions: Opt[Binding[org.freedesktop.cairo.FontOptions | Null]] = UnsetParam, gridLines: Opt[Binding[org.gnome.gtk.TreeViewGridLines]] = UnsetParam, hadjustment: Opt[Binding[org.gnome.gtk.Adjustment | Null]] = UnsetParam, halign: Opt[Binding[org.gnome.gtk.Align]] = UnsetParam, hasTooltip: Opt[Binding[Boolean]] = UnsetParam, headersClickable: Opt[Binding[Boolean]] = UnsetParam, headersVisible: Opt[Binding[Boolean]] = UnsetParam, hexpand: Opt[Binding[Boolean]] = UnsetParam, hexpandSet: Opt[Binding[Boolean]] = UnsetParam, hoverExpand: Opt[Binding[Boolean]] = UnsetParam, hoverSelection: Opt[Binding[Boolean]] = UnsetParam, hscrollPolicy: Opt[Binding[org.gnome.gtk.ScrollablePolicy]] = UnsetParam, layoutManager: Opt[Binding[org.gnome.gtk.LayoutManager | Null]] = UnsetParam, levelIndentation: Opt[Binding[Int]] = UnsetParam, limitEvents: Opt[Binding[Boolean]] = UnsetParam, marginBottom: Opt[Binding[Int]] = UnsetParam, marginEnd: Opt[Binding[Int]] = UnsetParam, marginStart: Opt[Binding[Int]] = UnsetParam, marginTop: Opt[Binding[Int]] = UnsetParam, model: Opt[Binding[org.gnome.gtk.TreeModel | Null]] = UnsetParam, name: Opt[Binding[java.lang.String]] = UnsetParam, opacity: Opt[Binding[Double]] = UnsetParam, overflow: Opt[Binding[org.gnome.gtk.Overflow]] = UnsetParam, receivesDefault: Opt[Binding[Boolean]] = UnsetParam, reorderable: Opt[Binding[Boolean]] = UnsetParam, rowSeparatorFunc: Opt[Binding[org.gnome.gtk.TreeViewRowSeparatorFunc | Null]] = UnsetParam, rubberBanding: Opt[Binding[Boolean]] = UnsetParam, searchColumn: Opt[Binding[Int]] = UnsetParam, searchEntry: Opt[Binding[org.gnome.gtk.Editable | Null]] = UnsetParam, searchEqualFunc: Opt[Binding[org.gnome.gtk.TreeViewSearchEqualFunc | Null]] = UnsetParam, sensitive: Opt[Binding[Boolean]] = UnsetParam, showExpanders: Opt[Binding[Boolean]] = UnsetParam, tooltipColumn: Opt[Binding[Int]] = UnsetParam, tooltipMarkup: Opt[Binding[java.lang.String | Null]] = UnsetParam, tooltipText: Opt[Binding[java.lang.String | Null]] = UnsetParam, vadjustment: Opt[Binding[org.gnome.gtk.Adjustment | Null]] = UnsetParam, valign: Opt[Binding[org.gnome.gtk.Align]] = UnsetParam, vexpand: Opt[Binding[Boolean]] = UnsetParam, vexpandSet: Opt[Binding[Boolean]] = UnsetParam, visible: Opt[Binding[Boolean]] = UnsetParam, vscrollPolicy: Opt[Binding[org.gnome.gtk.ScrollablePolicy]] = UnsetParam): ToolkitAction[Toolkit, TreeView] = {
