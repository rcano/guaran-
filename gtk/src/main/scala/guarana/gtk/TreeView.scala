...
object TreeView {
  ...
  val ExpanderColumn: ExternalVar.Aux[TreeView, org.gnome.gtk.TreeViewColumn | Null] = ExternalVar[TreeView, org.gnome.gtk.TreeViewColumn | Null]("expander-column", _.getExpanderColumn(), _.setExpanderColumn(_), true)
  ...
  val Model: ExternalVar.Aux[TreeView, org.gnome.gtk.TreeModel | Null] = ExternalVar[TreeView, org.gnome.gtk.TreeModel | Null]("model", _.getModel(), _.setModel(_), true)
