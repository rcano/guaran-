...
object AboutDialog {
  val Artists: ExternalVar.Aux[AboutDialog, Array[java.lang.String | Null]] = ExternalVar[AboutDialog, Array[java.lang.String | Null]]("artists", _.getArtists(), _.setArtists(_), true)
  val Authors: ExternalVar.Aux[AboutDialog, Array[java.lang.String | Null]] = ExternalVar[AboutDialog, Array[java.lang.String | Null]]("authors", _.getAuthors(), _.setAuthors(_), true)
  ...
  val Documenters: ExternalVar.Aux[AboutDialog, Array[java.lang.String | Null]] = ExternalVar[AboutDialog, Array[java.lang.String | Null]]("documenters", _.getDocumenters(), _.setDocumenters(_), true)
  ...
  val WebsiteLabel: ExternalVar.Aux[AboutDialog, java.lang.String | Null] = ExternalVar[AboutDialog, java.lang.String | Null]("website-label", _.getWebsiteLabel(), _.setWebsiteLabel(_), true)
