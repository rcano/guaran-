...
opaque type ColorChooserWidget <: guarana.gtk.Widget  = org.gnome.gtk.ColorChooserWidget & guarana.gtk.Widget
object ColorChooserWidget extends VarsMap {
  ...
  extension (v: ColorChooserWidget) {
    ...
    @deprecated("", "") def useAlpha: Var.Aux[Boolean, v.type] = guarana.gtk.ColorChooserWidget.UseAlpha.asInstanceOf[Var.Aux[Boolean, v.type]]
  ...
  def wrap(v: org.gnome.gtk.ColorChooserWidget): ColorChooserWidget = 
    val res = v.asInstanceOf[ColorChooserWidget]
  ...
  def uninitialized(showEditor: Opt[Boolean], cssName: Opt[java.lang.String], heightRequest: Opt[Int], widthRequest: Opt[Int], accessibleRole: Opt[org.gnome.gtk.AccessibleRole], rgba: Opt[org.gnome.gdk.RGBA]): ColorChooserWidget = {
    val res = {
      val res = org.gnome.gtk.ColorChooserWidget.builder()
