...
object ColorChooserWidget extends VarsMap {
  ...
  def _wrap(v: org.gnome.gtk.ColorChooserWidget): ColorChooserWidget = {
    v.asInstanceOf
  }
  def init(v: ColorChooserWidget): ToolkitAction[Toolkit, Unit] = {
    Widget.init(v)
