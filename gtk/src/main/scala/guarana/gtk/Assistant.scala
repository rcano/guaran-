...
opaque type Assistant <: guarana.gtk.Window  = org.gnome.gtk.Assistant & guarana.gtk.Window
object Assistant extends VarsMap {
  ...
  extension (v: Assistant) {
    ...
    @deprecated("", "") def currentPage: Var.Aux[Int, v.type] = guarana.gtk.Assistant.CurrentPage.asInstanceOf[Var.Aux[Int, v.type]]
  ...
  def wrap(v: org.gnome.gtk.Assistant): Assistant = 
    val res = v.asInstanceOf[Assistant]
  ...
  def uninitialized(useHeaderBar: Opt[Int], defaultHeight: Opt[Int], defaultWidth: Opt[Int], focusWidget: Opt[guarana.gtk.Widget], fullscreened: Opt[Boolean], maximized: Opt[Boolean], startupId: Opt[java.lang.String], cssName: Opt[java.lang.String], heightRequest: Opt[Int], widthRequest: Opt[Int], accessibleRole: Opt[org.gnome.gtk.AccessibleRole]): Assistant = {
    val res = org.gnome.gtk.Assistant.builder()
