...
object FlowBox {
  ...
  val SelectionMode: ExternalVar.Aux[FlowBox, org.gnome.gtk.SelectionMode | Null] = ExternalVar[FlowBox, org.gnome.gtk.SelectionMode | Null]("selection-mode", _.getSelectionMode(), _.setSelectionMode(_), true)
  ()
  extension (v: FlowBox) {
