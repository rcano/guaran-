...
opaque type IconView <: guarana.gtk.Widget  = org.gnome.gtk.IconView & guarana.gtk.Widget
object IconView extends VarsMap {
  ...
  extension (v: IconView) {
    ...
    @deprecated("", "") def activateOnSingleClick: Var.Aux[Boolean, v.type] = guarana.gtk.IconView.ActivateOnSingleClick.asInstanceOf[Var.Aux[Boolean, v.type]]
    @deprecated("", "") def columnSpacing: Var.Aux[Int, v.type] = guarana.gtk.IconView.ColumnSpacing.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def columns: Var.Aux[Int, v.type] = guarana.gtk.IconView.Columns.asInstanceOf[Var.Aux[Int, v.type]]
    def hadjustment: Var.Aux[org.gnome.gtk.Adjustment | Null, v.type] = guarana.gtk.IconView.Hadjustment.asInstanceOf[Var.Aux[org.gnome.gtk.Adjustment | Null, v.type]]
    def hscrollPolicy: Var.Aux[org.gnome.gtk.ScrollablePolicy, v.type] = guarana.gtk.IconView.HscrollPolicy.asInstanceOf[Var.Aux[org.gnome.gtk.ScrollablePolicy, v.type]]
    @deprecated("", "") def itemOrientation: Var.Aux[org.gnome.gtk.Orientation, v.type] = guarana.gtk.IconView.ItemOrientation.asInstanceOf[Var.Aux[org.gnome.gtk.Orientation, v.type]]
    @deprecated("", "") def itemPadding: Var.Aux[Int, v.type] = guarana.gtk.IconView.ItemPadding.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def itemWidth: Var.Aux[Int, v.type] = guarana.gtk.IconView.ItemWidth.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def margin: Var.Aux[Int, v.type] = guarana.gtk.IconView.Margin.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def markupColumn: Var.Aux[Int, v.type] = guarana.gtk.IconView.MarkupColumn.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def model: Var.Aux[org.gnome.gtk.TreeModel | Null, v.type] = guarana.gtk.IconView.Model.asInstanceOf[Var.Aux[org.gnome.gtk.TreeModel | Null, v.type]]
    @deprecated("", "") def pixbufColumn: Var.Aux[Int, v.type] = guarana.gtk.IconView.PixbufColumn.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def reorderable: Var.Aux[Boolean, v.type] = guarana.gtk.IconView.Reorderable.asInstanceOf[Var.Aux[Boolean, v.type]]
    @deprecated("", "") def rowSpacing: Var.Aux[Int, v.type] = guarana.gtk.IconView.RowSpacing.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def selectionMode: Var.Aux[org.gnome.gtk.SelectionMode, v.type] = guarana.gtk.IconView.SelectionMode.asInstanceOf[Var.Aux[org.gnome.gtk.SelectionMode, v.type]]
    @deprecated("", "") def spacing: Var.Aux[Int, v.type] = guarana.gtk.IconView.Spacing.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def textColumn: Var.Aux[Int, v.type] = guarana.gtk.IconView.TextColumn.asInstanceOf[Var.Aux[Int, v.type]]
    @deprecated("", "") def tooltipColumn: Var.Aux[Int, v.type] = guarana.gtk.IconView.TooltipColumn.asInstanceOf[Var.Aux[Int, v.type]]
    def vadjustment: Var.Aux[org.gnome.gtk.Adjustment | Null, v.type] = guarana.gtk.IconView.Vadjustment.asInstanceOf[Var.Aux[org.gnome.gtk.Adjustment | Null, v.type]]
    def vscrollPolicy: Var.Aux[org.gnome.gtk.ScrollablePolicy, v.type] = guarana.gtk.IconView.VscrollPolicy.asInstanceOf[Var.Aux[org.gnome.gtk.ScrollablePolicy, v.type]]
  ...
  def wrap(v: org.gnome.gtk.IconView): IconView = 
    val res = v.asInstanceOf[IconView]
  ...
  def apply(
    ...
    itemOrientation: Opt[Binding[org.gnome.gtk.Orientation]] = UnsetParam,
    itemPadding: Opt[Binding[Int]] = UnsetParam,
    itemWidth: Opt[Binding[Int]] = UnsetParam,
    ...
    markupColumn: Opt[Binding[Int]] = UnsetParam,
    ...
    textColumn: Opt[Binding[Int]] = UnsetParam,
