...
object Entry {
  ...
  val Attributes: ExternalVar.Aux[Entry, org.gnome.pango.AttrList | Null] = ExternalVar[Entry, org.gnome.pango.AttrList | Null]("attributes", _.getAttributes(), _.setAttributes(_), true)
  ...
  val Completion: ExternalVar.Aux[Entry, org.gnome.gtk.EntryCompletion | Null] = ExternalVar[Entry, org.gnome.gtk.EntryCompletion | Null]("completion", _.getCompletion(), _.setCompletion(_), true)
