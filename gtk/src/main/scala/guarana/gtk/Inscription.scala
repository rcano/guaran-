...
object Inscription {
  ...
  val TextOverflow: ExternalVar.Aux[Inscription, org.gnome.gtk.InscriptionOverflow | Null] = ExternalVar[Inscription, org.gnome.gtk.InscriptionOverflow | Null]("text-overflow", _.getTextOverflow(), _.setTextOverflow(_), true)
  val WrapMode: ExternalVar.Aux[Inscription, org.gnome.pango.WrapMode | Null] = ExternalVar[Inscription, org.gnome.pango.WrapMode | Null]("wrap-mode", _.getWrapMode(), _.setWrapMode(_), true)
