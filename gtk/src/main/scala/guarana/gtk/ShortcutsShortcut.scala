...
object ShortcutsShortcut extends VarsMap {
  ...
  def _wrap(v: org.gnome.gtk.ShortcutsShortcut): ShortcutsShortcut = {
    v.asInstanceOf
  }
  def init(v: ShortcutsShortcut): ToolkitAction[Toolkit, Unit] = {
    Widget.init(v)
