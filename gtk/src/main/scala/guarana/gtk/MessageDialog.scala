...
object MessageDialog extends VarsMap {
  ...
  def _wrap(v: org.gnome.gtk.MessageDialog): MessageDialog = {
    v.asInstanceOf
  }
  def init(v: MessageDialog): ToolkitAction[Toolkit, Unit] = {
    Dialog.init(v)
