...
object ShortcutLabel extends VarsMap {
  ...
  def _wrap(v: org.gnome.gtk.ShortcutLabel): ShortcutLabel = {
    v.asInstanceOf
  }
  def init(v: ShortcutLabel): ToolkitAction[Toolkit, Unit] = {
    Widget.init(v)
