...
object Popover {
  ...
  val Position: ExternalVar.Aux[Popover, org.gnome.gtk.PositionType | Null] = ExternalVar[Popover, org.gnome.gtk.PositionType | Null]("position", _.getPosition(), _.setPosition(_), true)
  ()
  extension (v: Popover) {
