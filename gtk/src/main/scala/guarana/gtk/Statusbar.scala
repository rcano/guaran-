...
object Statusbar extends VarsMap {
  ...
  def wrap(v: org.gnome.gtk.Statusbar): Statusbar = 
    val res = v.asInstanceOf[Statusbar]
  ...
  def uninitialized(cssName: Opt[java.lang.String], heightRequest: Opt[Int], widthRequest: Opt[Int], accessibleRole: Opt[org.gnome.gtk.AccessibleRole]): Statusbar = {
    val res = {
      val res = org.gnome.gtk.Statusbar.builder()
