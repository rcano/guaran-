...
object Statusbar extends VarsMap {
  ...
  def _wrap(v: org.gnome.gtk.Statusbar): Statusbar = {
    v.asInstanceOf
  }
  def init(v: Statusbar): ToolkitAction[Toolkit, Unit] = {
    Widget.init(v)
