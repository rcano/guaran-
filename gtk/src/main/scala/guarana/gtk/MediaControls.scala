...
object MediaControls extends VarsMap {
  ...
  def _wrap(v: org.gnome.gtk.MediaControls): MediaControls = {
    v.asInstanceOf
  }
  def init(v: MediaControls): ToolkitAction[Toolkit, Unit] = {
    Widget.init(v)
