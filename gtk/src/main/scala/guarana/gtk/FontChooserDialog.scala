...
object FontChooserDialog extends VarsMap {
  ...
  def apply(
    ...
    val res = uninitialized(useHeaderBar, defaultHeight, defaultWidth, focusWidget, fullscreened, maximized, startupId, cssName, heightRequest, widthRequest, accessibleRole, font, fontDesc)
