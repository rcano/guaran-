...
object MenuButton {
  ...
  val IconName: ExternalVar.Aux[MenuButton, java.lang.String | Null] = ExternalVar[MenuButton, java.lang.String | Null]("icon-name", _.getIconName(), _.setIconName(_), true)
  val Label: ExternalVar.Aux[MenuButton, java.lang.String | Null] = ExternalVar[MenuButton, java.lang.String | Null]("label", _.getLabel(), _.setLabel(_), true)
