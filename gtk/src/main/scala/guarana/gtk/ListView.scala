...
opaque type ListView <: guarana.gtk.Widget  = org.gnome.gtk.ListView & guarana.gtk.Widget
object ListView extends VarsMap {
  ...
  extension (v: ListView) {
    ...
    def enableRubberband: Var.Aux[Boolean, v.type] = guarana.gtk.ListView.EnableRubberband.asInstanceOf[Var.Aux[Boolean, v.type]]
    def factory: Var.Aux[org.gnome.gtk.ListItemFactory | Null, v.type] = guarana.gtk.ListView.Factory.asInstanceOf[Var.Aux[org.gnome.gtk.ListItemFactory | Null, v.type]]
    def headerFactory: Var.Aux[org.gnome.gtk.ListItemFactory | Null, v.type] = guarana.gtk.ListView.HeaderFactory.asInstanceOf[Var.Aux[org.gnome.gtk.ListItemFactory | Null, v.type]]
    def model: Var.Aux[org.gnome.gtk.SelectionModel[?] | Null, v.type] = guarana.gtk.ListView.Model.asInstanceOf[Var.Aux[org.gnome.gtk.SelectionModel[?] | Null, v.type]]
    def showSeparators: Var.Aux[Boolean, v.type] = guarana.gtk.ListView.ShowSeparators.asInstanceOf[Var.Aux[Boolean, v.type]]
    def singleClickActivate: Var.Aux[Boolean, v.type] = guarana.gtk.ListView.SingleClickActivate.asInstanceOf[Var.Aux[Boolean, v.type]]
    def tabBehavior: Var.Aux[org.gnome.gtk.ListTabBehavior, v.type] = guarana.gtk.ListView.TabBehavior.asInstanceOf[Var.Aux[org.gnome.gtk.ListTabBehavior, v.type]]
  ...
  def wrap(v: org.gnome.gtk.ListView): ListView = 
  ...
  def uninitialized(cssName: Opt[java.lang.String], heightRequest: Opt[Int], widthRequest: Opt[Int], accessibleRole: Opt[org.gnome.gtk.AccessibleRole]): ListView = {
    val res = {
      val res = org.gnome.gtk.ListView.builder()
