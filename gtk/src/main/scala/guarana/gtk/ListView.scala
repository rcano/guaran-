...
object ListView extends VarsMap {
  ...
  def init(v: ListView): Toolkit ?=> Unit = (tk: Toolkit) ?=> {
  ...
  def apply(
    arg$0: org.gnome.gtk.SelectionModel[?] | Null, arg$1: org.gnome.gtk.ListItemFactory | Null,
  ...
  ): Toolkit ?=> VarContextAction[ListView] = {
