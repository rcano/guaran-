...
object FlowBoxChild extends VarsMap {
  ...
  def _wrap(v: org.gnome.gtk.FlowBoxChild): FlowBoxChild = {
    v.asInstanceOf
  }
  def init(v: FlowBoxChild): ToolkitAction[Toolkit, Unit] = {
    Widget.init(v)
