...
object StackSwitcher extends VarsMap {
  ...
  def uninitialized(cssName: Opt[java.lang.String], heightRequest: Opt[Int], widthRequest: Opt[Int], accessibleRole: Opt[org.gnome.gtk.AccessibleRole]): StackSwitcher = {
    val res = {
      val res = org.gnome.gtk.StackSwitcher.builder()
