...
object Label {
  ...
  val FrameShadow: ExternalVar.Aux[Label, io.qt.widgets.QFrame.Shadow] = ExternalVar[Label, io.qt.widgets.QFrame.Shadow]("frameShadow", _.frameShadow().nn, _.setFrameShadow(_), true)
  val FrameShape: ExternalVar.Aux[Label, io.qt.widgets.QFrame.Shape] = ExternalVar[Label, io.qt.widgets.QFrame.Shape]("frameShape", _.frameShape().nn, _.setFrameShape(_), true)
  ...
  val TextFormat: ExternalVar.Aux[Label, io.qt.core.Qt.TextFormat] = ExternalVar[Label, io.qt.core.Qt.TextFormat]("textFormat", _.textFormat().nn, _.setTextFormat(_), true)
