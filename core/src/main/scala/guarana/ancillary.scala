...
extension [T](e: T | Null) inline def ?[U](inline f: T => U): U | Null = if (e != null) f(e.asInstanceOf[T]) else null
extension [T](e: T | Null) inline def nullFold[U](inline f: T => U, inline orElse: U): U = if (e != null) f(e.asInstanceOf[T]) else orElse
