...
/** {@link java.util.Map} implementation specialised for int keys using open addressing and linear probing for cache efficient access.
  *
  * @param [V]
...
class Int2ObjectHashMap[V <: Object | Null](
...
) extends Map[java.lang.Integer, V],
      Serializable {

  private var _resizeThreshold: Int = uninitialized
  private var _size: Int = 0

  private var keys: Array[Int] = uninitialized
  private[Int2ObjectHashMap] var _values: Array[Object | Null] = uninitialized
...

  {
    ...
    val capacity = findNextPositivePowerOfTwo(Math.max(Int2ObjectHashMap.MIN_CAPACITY, initialCapacity))
  ...
  def this(mapToCopy: Int2ObjectHashMap[V]) = {
    this(mapToCopy.capacity(), mapToCopy.loadFactor, mapToCopy.shouldAvoidAllocation)
    System.arraycopy(mapToCopy._values, 0, _values, 0, mapToCopy._values.length)
  }
  ...
  def containsKey(key: Object): Boolean = {
    return containsKey(key.asInstanceOf[java.lang.Integer].intValue())
  }
  ...
  def containsValue(value: Object): Boolean = {
    ...
    if (null != newVal)
    {
      var remaining = Int2ObjectHashMap.this.size
  ...
  def get(key: Object): V | Null = {
    return get(key.asInstanceOf[java.lang.Integer].intValue())
  }
  ...
  /** Get mapped value without boxing the key.
    ...
    */
  protected def getMapped(key: Int): V | Null = {
    val mask = _values.length - 1
    var index = Hashing.hash(key, mask)
  ...
  /** Get a value for a given key, or if it does not exist then default the value via a {@link java.util.function.LongFunction} and put it
    ...
    */
  def computeIfAbsent(key: Int, mappingFunction: LongFunction[? <: V]): V = {
  ...
  /** {@inheritDoc}
    */
  def put(key: java.lang.Integer | Null, value: V | Null): V | Null = {
    return put(key.nn.intValue(), value)
  }
  ...
  /** Overloaded version of {@link Map#put(Object, Object)} that takes a primitive int key.
    ...
    */
  def put(key: Int, value: V | Null): V | Null = {
  ...
  def remove(key: Object): V | Null = {
    return remove(key.asInstanceOf[java.lang.Integer].intValue())
  }
  ...
  def compact(): Unit = {
    ...
    rehash(findNextPositivePowerOfTwo(Math.max(Int2ObjectHashMap.MIN_CAPACITY, idealCapacity)))
  }

  /** {@inheritDoc}
    */
  def putAll(map: java.util.Map[? <: java.lang.Integer, ? <: V]): Unit = {
    val it = map.entrySet().nn.iterator().nn
    while (it.hasNext()) {
      val entry = it.next().asInstanceOf[java.util.Map.Entry[? <: java.lang.Integer, ? <: V]]
      put(entry.getKey().asInstanceOf[java.lang.Integer].intValue(), entry.getValue().asInstanceOf[V])
    }
  }
  ...
  override def hashCode(): Int = {
    ...
    while ({ i += 1; i < length })
    {
      val value = _values(i)
      if (null != value) {
        result += (java.lang.Integer.hashCode(keys(i)) ^ value.hashCode())
      }
    }
  ...
  /** Primitive specialised version of {@link #replace(Object, Object)}
    ...
    */
  def replace(key: Int, value: V): V | Null = {
  ...
  final class KeySet extends AbstractSet[java.lang.Integer], Serializable {
  ...
  final class EntrySet extends AbstractSet[java.util.Map.Entry[java.lang.Integer, V]], Serializable {
    ...
    override def contains(o: Object): Boolean = {
      ...
      val key = entry.getKey().asInstanceOf[Int]
  ...
  abstract class AbstractIterator[T] extends Iterator[T], Serializable {
    ...
    protected final def findNext(): Unit = {
      ...
      val _values = Int2ObjectHashMap.this._values
      val mask = _values.length - 1
    ...
    def reset(): Unit = {
      _remaining = Int2ObjectHashMap.this.size
      val _values = Int2ObjectHashMap.this._values
  ...
  class KeyIterator extends AbstractIterator[java.lang.Integer], Serializable {

    /** {@inheritDoc}
      */
    def next(): java.lang.Integer = {
      return nextLong()
    }
  ...
  class EntryIterator
      extends AbstractIterator[java.util.Map.Entry[java.lang.Integer, V]],
        java.util.Map.Entry[java.lang.Integer, V],
        Serializable {

    /** {@inheritDoc}
      */
    def next(): java.util.Map.Entry[java.lang.Integer, V] = {
      findNext()
    ...
    private[Int2ObjectHashMap] def allocateDuplicateEntry(): java.util.Map.Entry[java.lang.Integer, V] = {
      return new MapEntry(getLongKey(), getValue())
    }

    /** {@inheritDoc}
      */
    def getKey(): java.lang.Integer = {
      return getLongKey()
    }
    ...
    final class MapEntry(private val k: Int, private val v: V) extends java.util.Map.Entry[java.lang.Integer, V], Serializable {
      ...
      /** {@inheritDoc}
        */
      override def hashCode(): Int = {
        return java.lang.Integer.hashCode(getLongKey()) ^ (v.hashCode())
      }
