...
object TableView extends VarsMap {
  ...
  def apply(
    ...
    TableView.init(res)
    ifSet(UI, TableView.ops.extension_UI(res) := _)
    ...
    ifSet(autoCreateColumnsFromModel, TableView.ops.extension_autoCreateColumnsFromModel(res) := _)
    ifSet(autoCreateRowSorter, TableView.ops.extension_autoCreateRowSorter(res) := _)
    ifSet(autoResizeMode, TableView.ops.extension_autoResizeMode(res) := _)
    ...
    ifSet(cellEditor, TableView.ops.extension_cellEditor(res) := _)
    ifSet(cellSelectionEnabled, TableView.ops.extension_cellSelectionEnabled(res) := _)
    ifSet(columnModel, TableView.ops.extension_columnModel(res) := _)
    ifSet(columnSelectionAllowed, TableView.ops.extension_columnSelectionAllowed(res) := _)
    ...
    ifSet(dragEnabled, TableView.ops.extension_dragEnabled(res) := _)
    ifSet(dropMode, TableView.ops.extension_dropMode(res) := _)
    ifSet(editingColumn, TableView.ops.extension_editingColumn(res) := _)
    ifSet(editingRow, TableView.ops.extension_editingRow(res) := _)
    ifSet(enabled, Node.ops.extension_enabled(res) := _)
    ifSet(fillsViewportHeight, TableView.ops.extension_fillsViewportHeight(res) := _)
    ...
    ifSet(gridColor, TableView.ops.extension_gridColor(res) := _)
    ...
    ifSet(intercellSpacing, TableView.ops.extension_intercellSpacing(res) := _)
    ...
    ifSet(rowHeight, TableView.ops.extension_rowHeight(res) := _)
    ifSet(rowMargin, TableView.ops.extension_rowMargin(res) := _)
    ifSet(rowSelectionAllowed, TableView.ops.extension_rowSelectionAllowed(res) := _)
    ifSet(rowSorter, TableView.ops.extension_rowSorter(res) := _)
    ifSet(selectionBackground, TableView.ops.extension_selectionBackground(res) := _)
    ifSet(selectionForeground, TableView.ops.extension_selectionForeground(res) := _)
    ifSet(selectionModel, TableView.ops.extension_selectionModel(res) := _)
    ifSet(showHorizontalLines, TableView.ops.extension_showHorizontalLines(res) := _)
    ifSet(showVerticalLines, TableView.ops.extension_showVerticalLines(res) := _)
    ifSet(surrendersFocusOnKeystroke, TableView.ops.extension_surrendersFocusOnKeystroke(res) := _)
    ifSet(tableHeader, TableView.ops.extension_tableHeader(res) := _)
    ...
    ifSet(updateSelectionOnSort, TableView.ops.extension_updateSelectionOnSort(res) := _)
