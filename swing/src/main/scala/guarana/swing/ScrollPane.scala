...
object ScrollPane extends VarsMap {
  ...
  def apply(
    ...
    ScrollPane.init(res)
    ifSet(UI, ScrollPane.ops.extension_UI(res) := _)
    ...
    ifSet(botLeftCorner, ScrollPane.ops.extension_botLeftCorner(res) := _)
    ifSet(botRightCorner, ScrollPane.ops.extension_botRightCorner(res) := _)
    ifSet(bounds, Node.ops.extension_bounds(res) := _)
    ifSet(columnHeader, ScrollPane.ops.extension_columnHeader(res) := _)
    ...
    ifSet(content, ScrollPane.ops.extension_content(res) := _)
    ...
    ifSet(horizontalScrollBar, ScrollPane.ops.extension_horizontalScrollBar(res) := _)
    ifSet(horizontalScrollBarPolicy, ScrollPane.ops.extension_horizontalScrollBarPolicy(res) := _)
    ...
    ifSet(rowHeader, ScrollPane.ops.extension_rowHeader(res) := _)
    ifSet(toolTipText, Component.ops.extension_toolTipText(res) := _)
    ifSet(topLeftCorner, ScrollPane.ops.extension_topLeftCorner(res) := _)
    ifSet(topRightCorner, ScrollPane.ops.extension_topRightCorner(res) := _)
    ...
    ifSet(verticalScrollBar, ScrollPane.ops.extension_verticalScrollBar(res) := _)
    ifSet(verticalScrollBarPolicy, ScrollPane.ops.extension_verticalScrollBarPolicy(res) := _)
    ifSet(viewport, ScrollPane.ops.extension_viewport(res) := _)
    ifSet(viewportBorder, ScrollPane.ops.extension_viewportBorder(res) := _)
    ifSet(visible, Node.ops.extension_visible(res) := _)
    ifSet(wheelScrollingEnabled, ScrollPane.ops.extension_wheelScrollingEnabled(res) := _)
    res
  }
