...
object ListView extends VarsMap {
  ...
  def apply[E](
    ...
    ListView.init(res)
    ifSet(UI, ListView.ops.extension_UI(res) := _)
    ...
    ifSet(cellRenderer, ListView.ops.extension_cellRenderer(res) := _)
    ...
    ifSet(dragEnabled, ListView.ops.extension_dragEnabled(res) := _)
    ifSet(dropMode, ListView.ops.extension_dropMode(res) := _)
    ifSet(enabled, Node.ops.extension_enabled(res) := _)
    ifSet(fixedCellHeight, ListView.ops.extension_fixedCellHeight(res) := _)
    ifSet(fixedCellWidth, ListView.ops.extension_fixedCellWidth(res) := _)
    ...
    ifSet(layoutOrientation, ListView.ops.extension_layoutOrientation(res) := _)
    ...
    ifSet(selectedIndex, ListView.ops.extension_selectedIndex(res) := _)
    ifSet(selectedIndices, ListView.ops.extension_selectedIndices(res) := _)
    ifSet(selectionBackground, ListView.ops.extension_selectionBackground(res) := _)
    ifSet(selectionForeground, ListView.ops.extension_selectionForeground(res) := _)
    ifSet(selectionMode, ListView.ops.extension_selectionMode(res) := _)
    ifSet(selectionModel, ListView.ops.extension_selectionModel(res) := _)
    ...
    ifSet(valueIsAdjusting, ListView.ops.extension_valueIsAdjusting(res) := _)
    ...
    ifSet(visibleRowCount, ListView.ops.extension_visibleRowCount(res) := _)
    res
  }
