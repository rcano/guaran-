...
object BorderPane extends VarsMap {
  val Bottom: SwingVar.Aux[BorderPane, Node | Null] = SwingVar[BorderPane, Node | Null]("bottom", c => c.getLayout.asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.SOUTH).asInstanceOf[Node | Null], (p, n) => { if (n == null) p.remove(p.getLayout().asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.SOUTH)) else p.add(n.unwrap, BorderLayout.SOUTH) })
  val Center: SwingVar.Aux[BorderPane, Node | Null] = SwingVar[BorderPane, Node | Null]("center", c => c.getLayout.asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.CENTER).asInstanceOf[Node | Null], (p, n) => { if (n == null) p.remove(p.getLayout().asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.CENTER)) else p.add(n.unwrap, BorderLayout.CENTER) })
  ...
  val Left: SwingVar.Aux[BorderPane, Node | Null] = SwingVar[BorderPane, Node | Null]("left", c => c.getLayout.asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.WEST).asInstanceOf[Node | Null], (p, n) => { if (n == null) p.remove(p.getLayout().asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.WEST)) else p.add(n.unwrap, BorderLayout.WEST) })
  val Right: SwingVar.Aux[BorderPane, Node | Null] = SwingVar[BorderPane, Node | Null]("right", c => c.getLayout.asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.EAST).asInstanceOf[Node | Null], (p, n) => { if (n == null) p.remove(p.getLayout().asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.EAST)) else p.add(n.unwrap, BorderLayout.EAST) })
  val Top: SwingVar.Aux[BorderPane, Node | Null] = SwingVar[BorderPane, Node | Null]("top", c => c.getLayout.asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.NORTH).asInstanceOf[Node | Null], (p, n) => { if (n == null) p.remove(p.getLayout().asInstanceOf[BorderLayout].getLayoutComponent(BorderLayout.NORTH)) else p.add(n.unwrap, BorderLayout.NORTH) })
